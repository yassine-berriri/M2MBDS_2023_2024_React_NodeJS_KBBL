      ...
      <Col key={pxBoard.id} xs={24} sm={12} md={8} lg={6} xl={4} className="mb-24">
        <Card bordered={false} className="criclebox h-full">
          <Row gutter={[0, 20]}>
            ...
            <Col span={12}>
              {/* Button to navigate to the PixelBoard */}
              <Button onClick={() => handleClickonPxBoard(pxBoard._id)}>Go to PixelBoard</Button>
            </Col>
            <Col span={12} style={{ textAlign: 'right' }}>
              {/* Icon to export */}
              <IconButton onClick={() => handleExportImage(pxBoard.pixels)} aria-label="export image">
                <PhotoCamera />
              </IconButton>
            </Col>
          </Row>
